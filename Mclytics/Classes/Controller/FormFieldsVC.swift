...
//                }
                ...
                attachImage = CustomeAttacheFile(frame: CGRect(x: X_PADDING, y: yposition, width: 110, height: 110))
                ...
                attachVideo = CustomeAttacheFile(frame: CGRect(x: X_PADDING, y: yposition, width: 110, height: 110))
